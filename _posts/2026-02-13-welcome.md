...
### 3. The next big step
Before this, I worked on a [Chip-8 interpreter project](http://husaamkhan.com/chip-8-interpreter/), which operates similarly to an emulator on a smaller scale. That experience gave me a taste of what it's like to recreate a system from scratch, and now I'm ready to take the next big step: building a full Game Boy emulator.
